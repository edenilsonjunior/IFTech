...
INSERT INTO address (street, number, complement, district, zip_code, city, state) VALUES
('Rua das Flores', '123', 'Apto 101', 'Centro', '12345-678', 'São Paulo', 'SP'),
('Avenida Paulista', '456', 'Sala 202', 'Bela Vista', '87654-321', 'São Paulo', 'SP'),
('Rua do Comércio', '789', '', 'Jardins', '11223-334', 'São Paulo', 'SP'),
('Praça da Sé', '101', 'Lado Norte', 'Sé', '99887-665', 'São Paulo', 'SP'),
('Rua Augusta', '202', 'Casa', 'Consolação', '55443-221', 'São Paulo', 'SP');

-- Inserir dados na tabela customer
INSERT INTO customer (name, cpf, email, password, phone, active, address_id) VALUES
('João da Silva', '12345678900', 'joao@email.com', 'senha123', '(11) 91234-5678', 1, 1),
('Maria Oliveira', '98765432100', 'maria@email.com', 'senha456', '(11) 98765-4321', 1, 2),
('Carlos Santos', '45678912300', 'carlos@email.com', 'senha789', '(11) 99876-5432', 1, 3),
('Ana Costa', '32165498700', 'ana@email.com', 'senha321', '(11) 94567-1234', 1, 4),
('Fernanda Lima', '65432198700', 'fernanda@email.com', 'senha654', '(11) 93456-7890', 1, 5);
